...
{
    public class SimulatedDistanceSensor : IRangeFinder
    {
        protected List<IObserver<IChangeResult<Length>>> observers { get; set; } = new List<IObserver<IChangeResult<Length>>>();
        ...
        public SimulatedDistanceSensor(Length initialLength, Length? minLength = null, Length? maxLength = null)
        {
